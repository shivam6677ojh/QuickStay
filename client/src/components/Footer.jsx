...
const Footer = () => {
    return (
        <div className='bg-black text-gray-500/80 pt-10 px-6 md:px-16 lg:px-24 xl:px-32 bottom-0 w-full '>
            <div className='flex flex-wrap justify-between gap-10 md:gap-6'>
                ...
                <div>
                    <p className='font-playfair text-lg text-gray-300'>COMPANY</p>
                ...
                <div>
                    <p className='font-playfair text-lg text-gray-300'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80 w-full sm:w-auto'>
                    <p className='font-playfair text-lg text-gray-300'>STAY UPDATED</p>
