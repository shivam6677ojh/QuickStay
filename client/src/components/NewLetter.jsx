...
const NewsLetter = () => {
    ...
    return (
        <div className='flex justify-center items-center p-4  bg-[#0a0c1a] font-sans'>
            <div className="relative w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden">
                {/* Three.js canvas container */}
                <div ref={mountRef} className="absolute top-0 left-0 w-full h-full z-0" />

                {/* Content Overlay */}
                <div className="relative z-10 bg-[#1a1f2e]/80 backdrop-blur-sm p-8 sm:p-12 text-center">
                    {/* Heading */}
                    <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                        Stay Inspired
                    </h2>
                    ...
                    >
                        <input
                            ...
                            aria-label="Email Address"
                            required
                            className="bg-white/90 text-gray-800 placeholder-gray-500 px-4 py-3 rounded-lg border-0 w-full flex-grow focus:ring-2 focus:ring-blue-400 focus:outline-none transition-all duration-300"
                        />
                        <button
                            type="submit"
                            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg w-full sm:w-auto flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#1a1f2e] focus:ring-white transition-all duration-300 group"
                        >
                            Subscribe
                            {/* Inlined SVG Arrow */}
                            <svg 
                    ...
                    <div className="h-8 flex items-center justify-center">
                         {isSubscribed && (
                            <p className="text-green-400 transition-opacity duration-500">
